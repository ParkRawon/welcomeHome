...
public class UserDAO extends DAO {
	...
	public List<UserVO> getUsers() {
		...
		try {
			...
			while (rs.next()) {
				...
				vo.setUserBirth(rs.getString("user_brith"));
	...
	public void insertUser(UserVO vo) {
		// 사용자입력값을 받아서 오라클 디비에 입력처리.
		connect();
		String sql = "insert into users(user_id, user_pw, user_name, user_gen, user_hobby, user_brith) values(?,?,?,?,?,?)";
		try {

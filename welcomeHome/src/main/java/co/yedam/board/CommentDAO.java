...
public class CommentDAO extends DAO {
	// getinstance 메소드로 instance를 만들자
	...
	//글내용수정
		public HashMap<String, Object> update(Comment comment) {	
			connect();
			try {
				pstmt = conn.prepareStatement("update comments set name=?, content=? where id=?");
